...
kubectl apply -f kubernetes-manifests-dr/deployments/blue-deployments/auth-service/
kubectl apply -f kubernetes-manifests-dr/deployments/blue-deployments/conversion-service/
